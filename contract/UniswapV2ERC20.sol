...
contract UniswapV2ERC20 {
  ...
  string public constant name = 'NEOPIN LPs';
  string public constant symbol = 'NPT-LP';
  ...
  function permit(
    ...
    require(recoveredAddress != address(0) && recoveredAddress == owner, 'NeopinswapERC20: INVALID_SIGNATURE');
